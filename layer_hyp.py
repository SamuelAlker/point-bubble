...
def main():
    ...
    layer_placehold, layer_loss = training_new.layer_hyp(normalisation_layer, cells, datas, epochs, input_nodes, layer_number, layer_number_adjust, layer_placehold, layers_loss, lr, nodes)
